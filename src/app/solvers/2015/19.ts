...
export const solver201519: Solver = {
...
function parse(input: string): { replacements: string[][]; molecule: string } {
...
function replaceOne(molecule: string, replacements: string[][]): Set<string> {
...
function countMinTransformations(tokens: string[]): number {
